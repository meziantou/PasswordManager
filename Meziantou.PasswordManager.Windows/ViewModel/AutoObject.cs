...
namespace Meziantou.PasswordManager.Windows.ViewModel
{
    ...
    public abstract class AutoObject : IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether at least a property has changed since the last time this property has been set to
        ///     false.
        /// </summary>
        /// <value>
        ...
        protected virtual T GetProperty<T>([CallerMemberName] string name = null)
        {
            ...
            else
            {
                ...
                defaultValue = att != null ? ConvertUtilities.ChangeType(att.Value, default(T)) : default;
